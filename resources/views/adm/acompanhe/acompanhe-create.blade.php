            ...
            <div class="form-box">
                ...
                <form action="{{ url('/adm/acompanhe/') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('titulo') is-invalid @enderror" id="title" name="titulo" placeholder="Titulo" value="{{old('titulo')}}">
                        <span class="title-char-count"></span>
                    </div>

                    <div class="form-group">
                        <label for="subtitle">Resumo</label>
                        <textarea name="resumo" id="subtitle" rows="3" class="form-control @error('resumo') is-invalid @enderror" placeholder="Subtitulo">{{ old('resumo') }}</textarea>
                    ...
                    <div class="row" id="hide">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="date" id="date" class="form-control" value="{{ date('d/m/Y') }}" onkeyup="$(this).mask('00/00/0000')">
                            </div>
                        </div>
                    </div>
